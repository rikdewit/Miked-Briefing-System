...
import { StatusBadge, StatusCircle } from './Badges';
    ...
    <div className="w-full">
      ...
      <div className="sticky top-0 z-20">
        ...
        >
          ...
          <div className="hidden sm:block">By</div>
          <div></div>
        </div>
      </div>
                    ...
                    {categoryItems.map((item) => {
                      ...
                      return (
                        <div
                          ...
                          className={`grid gap-2 pl-8 pr-3 py-3 transition-colors cursor-pointer group items-center ${
                            isSelected
                        ...
                        >
                          ...
                          <div className="font-mono text-xs opacity-70 group-hover:opacity-100 flex-shrink-0 hidden sm:block">
